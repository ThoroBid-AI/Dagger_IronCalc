...
#[test]
fn test_batch1_fallback_arrayformula() {
    let mut model = new_empty_model();
...
#[test]
fn test_batch1_fallback_add_extra() {
    let mut model = new_empty_model();
    model._set("A2", "=ADD(1)");
    model.evaluate();
...
#[test]
fn test_batch1_fallback_beta_invn() {
    let mut model = new_empty_model();

    ...
    ($($field:ident => $variant:ident),+ $(,)?) => {
        impl Functions {
            pub fn lookup(&self, name: &str) -> Option<Function> {
                ...
                match key.as_str() {
                    // Backlog functions not yet present in locale metadata.
                    "ADDRESS" => Some(Function::Address),
                    "ARRAYFORMULA" => Some(Function::Arrayformula),
                    "ARRAY_CONSTRAIN" => Some(Function::Arrayconstrain),
                    "CHAR" => Some(Function::Char),
                    "CLEAN" => Some(Function::Clean),
                    "CODE" => Some(Function::Code),
                    "COUNTUNIQUE" => Some(Function::Countunique),
                    "CRITBINOM" => Some(Function::Critbinom),
                    "FILTER" => Some(Function::Filter),
                    "FVSCHEDULE" => Some(Function::Fvschedule),
                    "HYPERLINK" => Some(Function::Hyperlink),
                    "MMULT" => Some(Function::Mmult),
                    "MULTINOMIAL" => Some(Function::Multinomial),
                    "PROPER" => Some(Function::Proper),
                    "REPLACE" => Some(Function::Replace),
                    "SERIESSUM" => Some(Function::Seriessum),
                    "SPLIT" => Some(Function::Split),
                    "SUMPRODUCT" => Some(Function::Sumproduct),
                    "TRANSPOSE" => Some(Function::Transpose),
                    "UNICHAR" => Some(Function::Unichar),
                    _ => None,
                }
            }
        }
...
impl Function {
    pub fn to_localized_name(&self, language: &Language) -> String {
        ...
        match self {
            ...
            Function::Mmult => "MMULT".to_string(),
            ...
            Function::Multinomial => "MULTINOMIAL".to_string(),
            Function::Seriessum => "SERIESSUM".to_string(),
            ...
            Function::Arrayconstrain => "ARRAY_CONSTRAIN".to_string(),
            Function::Arrayformula => "ARRAYFORMULA".to_string(),
            Function::Filter => "FILTER".to_string(),
            ...
            Function::Split => "SPLIT".to_string(),
            ...
            Function::Unichar => "UNICHAR".to_string(),
            ...
            Function::Countunique => "COUNTUNIQUE".to_string(),
            ...
            Function::Critbinom => "CRITBINOM".to_string(),
...
impl<'a> Model<'a> {
    pub(crate) fn evaluate_function(
        ...
        match kind {
            ...
            Function::Arrayconstrain => self.fn_array_constrain(args, cell),
            Function::Arrayformula => self.fn_arrayformula(args, cell),
            ...
            Function::Split => self.fn_split(args, cell),
            ...
            Function::Critbinom => self.fn_critbinom(args, cell),
